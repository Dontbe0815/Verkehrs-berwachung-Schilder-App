...
export default function MapView(props: {
  ...
  const { settings, canCreate, locations, zones, selectedLocationId, onSelectLocation, onCreateLocation, onCreateZone, onViewportChanged } = props;
  ...
  return (
    <div className="relative h-[calc(100vh-56px)] w-full">
      ...
      <MapContainer center={center} zoom={settings.defaultZoom} className="h-full w-full" preferCanvas zoomControl={false}>
